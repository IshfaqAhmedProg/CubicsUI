...
import "./PasswordVisibilityIcon.styles.css";
    ...
    >
      <mask id={id} style={{ maskType: "luminance" }}>
        <path
          ...
          fill="white"
          className={"PasswordVisibilityIcon_eyelidMaskPath"}
        />
      </mask>
      <g className={"PasswordVisibilityIcon_eyeGroup"}>
        <path
          ...
          className={"PasswordVisibilityIcon_eyelidUpper"}
        />
        ...
        <path
          ...
          className={"PasswordVisibilityIcon_lashes"}
          pathLength="1"
        />
        <path
