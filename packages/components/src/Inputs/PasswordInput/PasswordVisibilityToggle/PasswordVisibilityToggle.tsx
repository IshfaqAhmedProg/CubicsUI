...
export function PasswordVisibilityToggle(
  ...
  return (
    <button
      ...
      {...rest}
    >
      <VisibilityToggleIcon closed={showPass} />
    </button>
  );
}
function VisibilityToggleIcon(
  props: ComponentProps<"svg"> & { closed?: boolean },
) {
  ...
  return (
    <svg
      ...
      width={width}
      height={height}
      className={cn("lucide", styles.main, closed ? styles.closed : "")}
    >
      ...
      <g className={styles.eyeGroup}>
        ...
        />
        <path
          d="M2.06251 11.6519C2.74835 13.7027 4.10913 15.4738 5.8979 16.7252C7.68667 17.9766 9.81695 18.6478 12 18.6478C14.1831 18.6478 16.3133 17.9766 18.1021 16.7252C19.8909 15.4738 21.2516 13.7027 21.9385 11.6519"
          className={styles.eyelidLower}
        />
        <path
