export const commandDesc = {
  init: "Prepares the project for component generation using CubicsUI by creating a configuration file and cache folder '.cui' and modifies existing '.gitignore' file to ignore '.cui' folder.",
